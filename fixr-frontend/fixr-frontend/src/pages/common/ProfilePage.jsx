...
export default function ProfilePage() {
  ...
  // Note: backend doesn't expose a PUT /api/auth/profile endpoint
  // This shows the current profile info from the JWT-stored user object
  const handleSave = () => {
    toast.success('Profile display updated (connect a backend endpoint to persist changes)')
  }
